...
We firmly believe that one should ***[dogfood](https://en.wikipedia.org/wiki/Eating_your_own_dog_food) the heck out of one's AI reading toolchain*** in order to get more out of one's reading processes. Dogfooding is the intensely recursive practice of using, designing, building, improving one's computational toolchain ...the RSSistant toolchain that we are working on is all about building a better AI dashboard for building a HYBRID intelligence capability. 

We must stress the hybrid nature of this activity ... this dogfooded development capability is not just AI, or even just the world of AI, like OpenAI or HuggingFace or other AI-centric development communities or firms ... but rather hybrid intelligence is about massively-multi-player development activities which are extending the realm of open source AI to complement ... it's about making the community development process itself more intelligent and *more well read* to expand the human intelligence which we gain through our reading processes, including those parts of the process where one discusses what was written with the author and others who have read the material ... hybrid intelligence is NECESSARILY and fundamentally a social activity ... AND it is computational.

In the realm of reading, this development activity is about working in the realm of natural language processing (NLP), computational linguistics, understanding the architecture of semiotic workflows, building better database internals for speedier, more efficient knowledge graph representations and just generally studying the structure of language and the written word in your particular areas of interest to help you navigate the world of ideas more intelligently.

*AI is not magic ... working on the low-level internals of things NLP can even be excrutiatingly tedious at times -- doing original work is necessarily HARD.*  

The point is to get those microtasks that must be done thousands of times each day or each hour to be more efficient and much faster ... in the bigger picture, AI for a reading toolchain is all about smarter map for better navigation to take you more expeditiously to exactly where you want to go ... it's not about replacing interaction with humans, it's about navigation in the virtural realm.  

Improving your reading toolchain is all about getting to ideas faster ... the general point of doing this to help you build tools that more effectively find the few people on the planet with the ideas which represent shared interests for you ... there might be 50,000 to 100,000 who truly share your focus, your unique areas of interest and the people in that group will change ... but those people are unlikely to ALL be located in your geographic vicinity, even if you are working at a research institution.

Thus, the point of building better toolchains for hybrid intelligence is so that we may exchange ideas more efficiently with people who want to exchange ideas with you ... and avoid the waste of confining your exchange of ideas according to what are now artifical constraints which bind in the physical realm. 

An improved reading toolchain for hybrid intelligence is mostly about time management, just generally getting more out of each second ... but it is also about just generally being better able to contribute to the world's stock of knowledge capital. 

# Listify

Listification is about further processing of the raw material that an AI reading toolchain delivers into higher value knowledge and more coherent bodies of information ... the foundation of this involves the very simple task of better annoation to improve the value and connectedness of curated reading lists. We can develop the process of listification by looking into the listification of Classics ... the study of the Classics, in a meta sense, teaches us about how knowledge is distilled over time.

A curated Classics reading list is not exactly so much about individual original Classics but rather it's about the Classics process ... that means looking at writing about writing about writing, over the ages, about how an orginal work becomes influentials to generations of really smart people with unique takes on not just the original Classic, but their take on the generations of scholarship that happened before ... it is impossible for anything become a truly legitimate Classic within an author's lifetime, because of how the process of becoming part of the Classic canon REQUIRES generations upon generations upon generations of asynchronous, longitudinal commentary and commentary about commentary.
