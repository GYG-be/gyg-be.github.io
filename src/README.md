...
- It started with something from [Matt Berman](https://gist.github.com/mberman84) and still reflects his sensabilities, but it's an example of good template to start with; there are other [Awesome OpenClaw Agents](https://github.com/mergisi/awesome-openclaw-agents) to peruse as well as repositories like [https://github.com/kellyclaudeai/openclaw-deck](https://github.com/kellyclaudeai/openclaw-deck)
